...
\begin{proof}[Dimostrazione]
    ...
    Poiché $|f|=C(S,T)$ e grazie al \nameref{def:155} sappiamo che $|f|\leq
    C(S',T')$ per ogni \emph{taglio} $(S',T')$, possiamo affermare che $(S,T)$
    è un \emph{taglio} di \emph{capacità} minima.
