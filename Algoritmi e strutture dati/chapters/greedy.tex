...
al ramo destro è sempre associato il bit 1. I caratteri si trovano nelle foglie
e il \emph{cammino} che si percorre per andare dalla \emph{radice} a ciascuna
\emph{foglia} corrisponde alla codifica del carattere associato.
...
\begin{note}
    ...
    \emph{nodo} mediante un attributo $f$.
\end{note}
...
\emph{sottostruttura ottima} per cui dato un problema sull'alfabeto $\Sigma$,
è possibile costruire un sotto-problema con un alfabeto più piccolo aggregando
i due caratteri con frequenza minore.
