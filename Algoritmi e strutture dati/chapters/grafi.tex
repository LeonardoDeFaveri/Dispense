...
\begin{figure}[h!]
    ...
    \subfloat[\emph{Grafo ciclico}]
    {
        ...
        \begin{graph}
            ...
            \draw[->] (0) -- (2);
            \draw[->] (1) -- (3);
            \draw[->, line width=1.2pt] (2) -- (3);
            \draw[->, line width=1.2pt] (4) -- (2);
...
sono gli \emph{archi dell'albero di copertura}, mentre gli \emph{archi} $(a,c)$
e $(c,a)$ sono, rispettivamente, un \emph{arco in avanti} e un \emph{arco
all'indietro}. Infine, gli \emph{archi} uscenti da $d$ sono \emph{archi di
attraversamento}.
...
\begin{figure}[h!]
    ...
    \subfloat[\emph{Componenti fortemente connesse}]
    {
        \begin{graph}
            ...
            \draw[color=red, dashed, line width=1.2pt] (0) circle (0.6);
            \draw[color=red, dashed, line width=1.2pt] (1) circle (0.6);
            \draw[color=red, dashed, line width=1.2pt, rotate=35] (4) [yshift=38, xshift=21] ellipse (3.4 and 2.15);
