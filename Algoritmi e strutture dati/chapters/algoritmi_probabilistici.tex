...
\begin{code}{Bloom filter}
    ...
    \com{Se restituisce \textbf{false}, $k$ è certamente assente, ma se
    restituisce \textbf{true},}
    \com{l'elemento potrebbe essere presente oppure no}
...
\end{graph}}}\\
\subfloat[Test di esistenza per elemento non presente]{
\resizebox{0.48\textwidth}{!}{\begin{graph}
    \tikzset{
        cell/.style={rectangle, draw, minimum size=10mm}
    }
...
\end{graph}}}
\hfill
\subfloat[Test di esistenza per elemento presente]{
\resizebox{0.48\textwidth}{!}{\begin{graph}
    \tikzset{
        cell/.style={rectangle, draw, minimum size=10mm}
    }
    ...
    \path[->]   (k2) edge[out=-90, in=90, looseness=1] (4)
                ...
                (k2) edge[out=-90, in=90, looseness=1] (9);
\end{graph}}}\\
\subfloat[Test di esistenza per falso positivo]{
\resizebox{0.48\textwidth}{!}{\begin{graph}
    \tikzset{
        cell/.style={rectangle, draw, minimum size=10mm}
    }
