...
più a sinistra dell'insieme, ovvero dal punto $p_0$ con ordinata minore. A quel
punto, viene calcolato l'angolo di inclinazione delle rette passanti per $p_0$ e
ogni altro punto rispetto alla verticale. Il punto $p_1$ associato alla retta con
angolo minore viene selezionato come vertice del poligono. Il tutto viene ripetuto
fino a quando non viene selezionato di nuovo come vertice il punto $p_0$.