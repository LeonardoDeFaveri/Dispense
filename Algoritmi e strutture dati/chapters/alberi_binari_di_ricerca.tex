...
\begin{figure}[h!]
    ...
    \resizebox*{\textwidth}{!}{
        \begin{graph}
            ...
            \node[nil] (17) [below left of=14, xshift=25, yshift=-3] {Nil};
            \node[nil] (18) [below right of=14, xshift=-25, yshift=-3] {Nil};
            \node[nil] (19) [below left of=15, xshift=25, yshift=-3] {Nil};
            \node[nil] (20) [below right of=15, xshift=-25, yshift=-3] {Nil};
            \node[nil] (21) [below left of=16, xshift=25, yshift=-3] {Nil};
            \node[nil] (22) [below right of=16, xshift=-25, yshift=-3] {Nil};
