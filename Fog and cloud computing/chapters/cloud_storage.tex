...
The interface is simpler because there's no symbolic or hard links, no file move,
...
directory (\q{servers} directory) and the \emph{master} monitors this directory
...
\begin{enumerate}
    ...
    \item It scans the \q{servers} directory in \emph{Chubby} to find all live
    \emph{tablet servers};
