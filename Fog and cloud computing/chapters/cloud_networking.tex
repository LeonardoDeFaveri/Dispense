...
hardware. Talking about its implementation, it's implemented into the Linux
...
\begin{eg}[Example of communication]
    ...
    \begin{figure}[h!]
        \centering
        \subfloat{\includegraphics[width=0.48\textwidth, valign=c]{putting-all-together-details.png}}
        \hfill
        \subfloat{\includegraphics[width=0.48\textwidth, valign=c]{putting-all-together-tables.png}}
    \end{figure}
...
\begin{figure}[h!]
    \centering
    \subfloat[\emph{Tenent view}]{\includegraphics[width=0.38\textwidth, valign=c]{t-view1.png}}
    \hspace{1.5cm}
    \subfloat[\emph{Cloud manager view}]{\includegraphics[width=0.38\textwidth, valign=c]{cm-view1.png}}
